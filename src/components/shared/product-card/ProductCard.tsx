  ...
  return (
    <div className="w-[240px] bg-white rounded-md flex flex-col">
      ...
      <div className="flex-1 p-4 flex flex-col justify-between">
        ...
        {showRating && <div className="flex justify-between items-center text-xs mt-2">
        ...
        <div className="flex justify-between mt-4">
          ...
          <div className="flex flex-col">
            <span className="text-sm">
              <span className="text-xl ml-1 font-bold">{productData.finalPrice}</span>تومان
            </span>
            <span className="text-gray-600 line-through">{productData.price}</span>
          </div>
        </div>
      </div>
    </div>
